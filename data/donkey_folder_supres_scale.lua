...
local cache = "cache_scale"
local cache_prefix = opt.data:gsub('/', '_')
os.execute('mkdir -p cache_scale')
local trainCache = paths.concat(cache, cache_prefix .. '_trainCache.t7')

--------------------------------------------------------------------------------------------
local loadSize   = {1, opt.loadSize/opt.scale}
local sampleSize = {1, opt.fineSize/opt.scale}
...
if paths.filep(trainCache) then
   ...
   trainLoader.loadSize = {1, opt.loadSize/opt.scale, opt.loadSize/opt.scale}
